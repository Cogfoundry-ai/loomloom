...
> 由胜算云出品 · [github.com/SSYCloud/loomloom](http://github.com/SSYCloud/loomloom) · [gitee.com/shengsuanyun/loomloom](https://gitee.com/shengsuanyun/loomloom)
...
我的服务器地址是 https://loomloom.shengsuanyun.com/batch，Token 是 your-token
安装好之后帮我跑一下 doctor 检查是否正常
```

国内网络环境也可以使用 Gitee 分发仓库：

```
请你去这个 Gitee 项目安装 LoomLoom：https://gitee.com/shengsuanyun/loomloom
我的服务器地址是 https://loomloom.shengsuanyun.com/batch，Token 是 your-token
安装好之后帮我跑一下 doctor 检查是否正常
```
...
# 指定版本
curl -fsSL https://raw.githubusercontent.com/SSYCloud/loomloom/main/install.sh | bash -s -- --version v0.2.7
...
curl -fsSL https://raw.githubusercontent.com/SSYCloud/loomloom/main/install.sh | bash -s -- --version v0.2.6-beta.9 --no-brew
```
...
**Gitee 国内分发（macOS / Linux）：**

```bash
# 默认安装（Codex 技能包）
curl -fsSL https://gitee.com/shengsuanyun/loomloom/raw/main/install-gitee.sh | bash

# Claude 用户
curl -fsSL https://gitee.com/shengsuanyun/loomloom/raw/main/install-gitee.sh | bash -s -- --agent claude

# OpenClaw 用户
curl -fsSL https://gitee.com/shengsuanyun/loomloom/raw/main/install-gitee.sh | bash -s -- --agent openclaw

# 内测版本：安装当前最新 beta
curl -fsSL https://gitee.com/shengsuanyun/loomloom/raw/main/install-gitee.sh | bash -s -- --channel beta

# 内测版本：安装指定 pre-release tag
curl -fsSL https://gitee.com/shengsuanyun/loomloom/raw/main/install-gitee.sh | bash -s -- --version v0.2.6-beta.9
```

> Gitee 安装入口只从 Gitee Release 下载二进制包和技能包，不走 Homebrew。

**已经安装过，如何通过 Gitee 更新？**

重复执行 Gitee 安装命令即可覆盖更新本机 CLI 和对应技能包：
...
# 内测版本：安装指定 pre-release tag
& ([scriptblock]::Create((irm https://raw.githubusercontent.com/SSYCloud/loomloom/main/install.ps1))) -Version v0.2.6-beta.9
```

> Windows 默认安装路径：`$HOME\AppData\Local\Programs\loomloom`，若未自动加入 PATH，请手动添加。

**Gitee 国内分发（Windows PowerShell）：**

```powershell
# 默认安装
& ([scriptblock]::Create((irm https://gitee.com/shengsuanyun/loomloom/raw/main/install.ps1))) -Source gitee

# Claude 用户
& ([scriptblock]::Create((irm https://gitee.com/shengsuanyun/loomloom/raw/main/install.ps1))) -Source gitee -Agent claude

# 内测版本：安装当前最新 beta
& ([scriptblock]::Create((irm https://gitee.com/shengsuanyun/loomloom/raw/main/install.ps1))) -Source gitee -Channel beta

# 内测版本：安装指定 pre-release tag
& ([scriptblock]::Create((irm https://gitee.com/shengsuanyun/loomloom/raw/main/install.ps1))) -Source gitee -Version v0.2.6-beta.9
```
...
```bash
export LOOMLOOM_SERVER="https://loomloom.shengsuanyun.com/batch"
...
**👉 [https://loomloom.shengsuanyun.com/home](https://loomloom.shengsuanyun.com/home)**
...
- 📊 任务进度看板：[loomloom.shengsuanyun.com/home](https://loomloom.shengsuanyun.com/home)
